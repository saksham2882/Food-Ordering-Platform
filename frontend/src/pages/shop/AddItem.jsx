      ...
      <div className="min-h-[80vh] flex items-center justify-center py-10 px-4 ">
        <div className="max-w-xl w-full bg-white shadow-2xl shadow-slate-400/50 rounded-3xl p-8 border border-gray-100 relative animate-in fade-in zoom-in-95 duration-500">
          ...
          <div className="text-center mb-10 mt-2">
            ...
            <h2 className="text-3xl font-black text-slate-900 tracking-tight">Add New Item</h2>
            <p className="text-gray-500 font-medium">Expand your menu with delicious food</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <Button
              ...
              type="submit"
            >
              {loading ? <Spinner className="mr-2 h-4 w-4 animate-spin" /> : "Add to Menu"}
            </Button>
          </form>
        </div>
      </div>
